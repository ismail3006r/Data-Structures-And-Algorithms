...
public class DiameterOfATree {
    ...
    static class BinaryTree{
        ...
        public int Diameter(Node root){
            ...
            int lsubTHeight = height(root.left);
            int rsubTHeight = height(root.right);

            int selfDia =lsubTHeight+rsubTHeight+1; 
            diameter=Math.max(selfDia,Math.max(leftDia,rightDia));
            return diameter;
        }
    }
    public static void main(String[] args) {
        ...
        System.out.println(b1.Diameter(root));
    }
}